...
<head>
    ...
    {{-- Mengambil nama aplikasi dari .env file. --}}
    ...
    <!-- Scripts -->
    {{-- Direktif @vite hanya perlu satu kali. Duplikasi telah dihapus. --}}
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        {{-- Bagian navigasi (navbar) yang mungkin berisi logo dashboard (application-mark.blade.php) --}}
